...
public class RegForm extends JFrame {
    ...
    RegForm(String A) {
        ...
        // Icon icon = new ImageIcon("..\\JavaProject_PCCOE\\icons8-closed-eye-20.png");
        ...
        Icon icon1 = new ImageIcon("..\\JavaProject_PCCOE\\icons8-left-arrow-30.png");
        ...
        btnSubmit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (A == "UPDATE") {
                    ...
                    } else if (txtfname.getText().equals("") || txtmname.getText().equals("")
                            || txtlname.getText().equals("")) {
                        JOptionPane.showMessageDialog(btnSubmit, "Fill all the Details");
                    } else {
                        try {
                            Connection connection = DriverManager
                                    .getConnection("jdbc:mysql://localhost:3306/activityjava", "root", "Somesh@Bang");
                            ...
                            /*
                             * Admin cant change gender i tried all thing but
                             * now i am tired and lost 4 days doing this so
                             * i will do it later whenever i will have time
                             */
                    ...
                    if (txtuser.getText().equals("")) {
                        ...
                        try {
                            Connection connection = DriverManager
                                    .getConnection("jdbc:mysql://localhost:3306/activityjava", "root", "Somesh@Bang");
                            String query = " insert into userdetails (name,middlename,lastname,phonenumber,username,password,emailid,dob,gender,address,usertype)"
                                    + " values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                            PreparedStatement preparedStmt = connection.prepareStatement(query);
                            preparedStmt.setString(1, uName);
                            preparedStmt.setString(2, uMiddleName);
        ...
        if (A == "ADMIN" || A == "UPDATE") {
            ...
            Icon icon2 = new ImageIcon("..\\JavaProject_PCCOE\\icons8-left-arrow-30.png");
    ...
    public void UpdateUsers(String UU) {
        ...
        // try {
        // Image img = ImageIO.read(new FileInputStream("icons8-left-10.png"));
        // Image newimg = img.getScaledInstance(290, 220, java.awt.Image.SCALE_SMOOTH);
        // btnBTUser.setIcon(new ImageIcon(newimg));
        // }
        ...
        BtnUUpdate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ee) {
                ...
                try {
                    Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/activityjava",
                            "root", "Somesh@Bang");
    ...
    public void adminUpdate(int uid) {
        ...
        Icon icon3 = new ImageIcon("..\\JavaProject_PCCOE\\icons8-left-arrow-30.png");
