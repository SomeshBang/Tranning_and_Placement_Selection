...
class MyFrame extends JFrame {
    ...
    MyFrame() {
        ...
        c = getContentPane();
        c.setLayout(null);
        Color customColor = new Color(190, 3, 252); //227, 186, 143
        ...
        showPass.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (showPass.isSelected()) {
                    ...
                    Icon icon1 = new ImageIcon("..\\JavaProject_PCCOE\\icons8-eye-20.png ");
                    showPass.setIcon(icon1);
                } else {
                    txtPassword.setEchoChar('*');
                    Icon icon2 = new ImageIcon("..\\JavaProject_PCCOE\\icons8-closed-eye-20.png");
        ...
        SignUpBtn.setFont(new Font("MS UI Gothic", 3, 14));
                    ...
                    if (Username.isEmpty() || Password.isEmpty()) {
                        ...
                        try {
                            ...
                            PreparedStatement stmt = connection
                                    .prepareStatement("SELECT username, password, usertype FROM " + checkUType
